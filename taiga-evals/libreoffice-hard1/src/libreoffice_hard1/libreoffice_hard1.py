...
problems = [
    Problem(
        id="libreoffice-hard1",
        statement="""
Given the transaction data transaction_data.ods and the currency conversion table, convert the transactions to USD. 
Output goal: Provide a summary table with two columns. Account, and USD. Accounts need to be sorted alphabetically (A to Z). 
Put your answer in a tab called ""OUTPUT"" in a file called transaction_data_analysis
Ensure ""Account"" is on A1 and ""USD"" is on B1
USD values should indicate the USD converted 'Amounts'.
Put your answer in a tab called ""OUTPUT"" in a file called transaction_data_analysis.ods - ensure ""Account"" is on A1 and ""USD"" is on B1 in the /home/model directory"
        """,
