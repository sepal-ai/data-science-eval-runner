...
async def verify_output_file() -> int:
    ...
    """
    output_path = Path("/home/model/accounts.ods")
    expected_csv_path = Path("/workdir/image/outputs/accounts.csv")
    ...
    try:
        ...
        converted_file = temp_dir / "accounts.csv"
...
problems = [
    Problem(
        id="libreoffice-easy1",
        statement="""
        In a new file called accounts.ods, create a table with two columns. Account, and USD.
        The header row should be "Account" and "USD".
        The data below the header should be the following:
        column 1: ACME, Inc. ;column 2: $1.00

        The sheet name should be "OUTPUT"
        The file should be saved in the /home/model directory to a file called accounts.ods
        """,
